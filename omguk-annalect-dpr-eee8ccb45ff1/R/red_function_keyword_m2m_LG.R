...
red_function_keyword_m2m_LG <- function(username,pw,DPID,dbname="lgiemea",dbHost="54.154.112.90",
                         agency,advertiserIds,campaignIds,activity_sub_type, join_type="Left", activity_type=NULL, eventid.ign=NULL, 
...
"))
  ...
  dbSendQuery(redshift_con,paste0("
                                  drop table if exists ds_",agency,".","DP",date_code,"_",analyst_code,"_",DPID,"_na_filt_browser;
                                  CREATE TABLE ds_",agency,".","DP",date_code,"_",analyst_code,"_",DPID,"_na_filt_browser as
  ...
  dbSendQuery(redshift_con,paste0("
                                  DELETE FROM ds_",agency,".","DP",date_code,"_",analyst_code,"_",DPID,"_na_filt_browser
                                  WHERE user_id not in (select user_id from ds_",agency,".","DP",date_code,"_",analyst_code,"_",DPID,"_icm_conv);"))
  ...
  na_browser_Q <- dbSendQuery(redshift_con,paste0("
                                                  select * from ds_",agency,".","DP",date_code,"_",analyst_code,"_",DPID,"_na_filt_browser
                                                  "))
...
save(na_browser, file = file.path(file_save_location,paste0(analyst,"_",DPID_save,"_na_browser.RData")))
