...
red_function_keyword_page_id <- function(username,pw,DPID,dbname="annalectuk",dbHost="54.77.118.78",
                         agency,networkId,advertiserIds,campaignIds,activity_ids, activity_type=NULL, eventid.ign=NULL, 
...
if(ppc_match) {
  ...
  colnames(hierarchy) <- gsub("[^a-z_]*","",colnames(hierarchy))
    ...
    hierarchy <- hierarchy[,c(ppc_match_col,"placement_id","sub_channel","channel")]
...
dbSendQuery(redshift_con,paste0("
    ...
    FROM ds_",agency,".","DP",date_code,"_",analyst_code,"_",DPID,"_icm as ic
    join ds_",agency,".dc2_match_paid_search as d
    ...
    and ic.placement_id = cat.placement_id
